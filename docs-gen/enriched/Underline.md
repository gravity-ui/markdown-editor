...
This markdown extension adds marks such as `ins`, 1 editor action to the editor pipeline. It is included in `YfmPreset`, `FullPreset`. The extracted test markup shows how the feature is expected to appear in real content.
...
- Enable it when your editor setup needs marks `ins`.
