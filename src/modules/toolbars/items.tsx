...
import {ToolbarItemCommon, ToolbarItemMarkup, ToolbarItemWysiwyg} from './types';
...
// ---- Undo ----
export const undoItemCommon: ToolbarItemCommon = {
...
// ---- Redo ----
export const redoItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Bold ----
export const boldItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Italic ----
export const italicItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Underline ----
export const underlineItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Strikethrough ----
export const strikethroughItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Monospace ----
export const monospaceItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Marked ----
export const markedItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Checkbox ----
export const checkboxItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Link ----
export const linkItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Quote ----
export const quoteItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Cut ----
export const cutItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Note ----
export const noteItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Table ----
export const tableItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Code ----
export const codeItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Image ----
export const imageItemCommon: ToolbarItemCommon = {
...
// ---- File ----
export const fileItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.ButtonPopup,
...
// ---- Tabs ----
export const tabsItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Math Inline ----
export const mathInlineItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Math Block ----
export const mathBlockItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Yfm Html Block ----
export const yfmHtmlBlockItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Mermaid ----
export const mermaidItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Code Block ----
export const codeBlockItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Horizontal Rule ----
export const hruleItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Emoji ----
export const emojiItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 1 ----
export const heading1ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 2 ----
export const heading2ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 3 ----
export const heading3ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 4 ----
export const heading4ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 5 ----
export const heading5ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading 6 ----
export const heading6ItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Bullet List ----
export const bulletListItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Ordered List ----
export const orderedListItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Sink List ----
export const sinkListItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Lift List ----
export const liftListItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
export const toggleHeadingFoldingItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Text Context ----
export const textContextItemCommon: ToolbarItemCommon = {
...
// ---- Paragraph ----
export const paragraphItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
export const paragraphItemMarkup: ToolbarItemWysiwyg = {
    exec: noop,
    isActive: inactive,
    isEnable: enable,
};
...
// --- Colorify ----
export const colorifyItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.ReactComponent,
};
...
// ---- GPT ----
export const gptItemCommon: ToolbarItemCommon = {
    type: ToolbarDataType.SingleButton,
...
// ---- Heading list ----
export const headingListItemCommon: ToolbarItemCommon<ToolbarDataType.ListButton> = {
...
// ---- Lists list ----
export const listsListItemCommon: ToolbarItemCommon<ToolbarDataType.ListButton> = {
    type: ToolbarDataType.ListButton,
    icon: icons.bulletList,
    withArrow: true,
...
// ---- Move list ----
export const moveListItemCommon: ToolbarItemCommon<ToolbarDataType.ListButton> = {
    type: ToolbarDataType.ListButton,
    icon: icons.lift,
    withArrow: true,
...
// ---- Code list ----
export const codeBlocksListItemCommon: ToolbarItemCommon<ToolbarDataType.ListButton> = {
    type: ToolbarDataType.ListButton,
    icon: icons.code,
...
// ---- Math list ----
export const mathListItemCommon: ToolbarItemCommon<ToolbarDataType.ListButton> = {
    type: ToolbarDataType.ListButton,
    icon: icons.functionInline,
    withArrow: true,
