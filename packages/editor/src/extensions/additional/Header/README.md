...
Пункт «Кнопки» объединяет добавление кнопок и ссылок, их адреса, вид и цвет.
«Поменять местами» меняет порядок двух действий, сохраняя их настройки и введённые адреса.
