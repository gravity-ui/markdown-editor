...
export interface YfmHtmlConstructorOptions {
    ...
    showButton?: boolean;
    /** Allow template imports; shared in memory and persisted when storage is available. */
    allowAdd?: boolean;
}

export interface YfmHtmlConstructorExtensionOptions {
    templates?: YfmHtmlConstructorOptions;
    /** Scope exported CSS to one constructor. Editor previews are always scoped. */
    scopeStyles?: boolean;
}
