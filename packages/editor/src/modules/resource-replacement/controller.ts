...
/** One controller belongs to one editor lifecycle, shared by its two modes. */
export class ResourceReplacementController implements ResourceReplacementControl {
    ...
    private options: ResourceReplacementConfig;
    ...
    destroy() {
        ...
        // A resolver may ignore abort and retain this controller until it settles.
        this.options = {};
        this.onUpdate = () => {};
        this.reportError = () => {};
    }
