...
import {YfmPageConstructor} from '@gravity-ui/markdown-editor/extensions/additional/YfmPageConstructor/index.js';
...
const wCommandMenuConfig = wysiwygToolbarConfigs.wCommandMenuConfig.concat(
    ...
    wysiwygToolbarConfigs.wYfmPageConstructorItemData,
