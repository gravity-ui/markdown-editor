...
export const Toolbars = React.memo<PresetDemoProps>((props) => {
    const {
        preset,
        settingsVisible,
        allowHTML,
    ...
    return (
        <div className={b()}>
            <div className={b('header')}>
                <>Markdown Editor ({typeof preset === 'string' ? preset : 'custom'} preset)</>
...
Toolbars.displayName = 'PresetDemo';
